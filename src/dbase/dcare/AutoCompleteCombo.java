...
public class AutoCompleteCombo extends JComboBox implements JComboBox.KeySelectionManager {
    ...
    private void AutoCompleteInit() {
        lap = new connect.SystemOptions().ServerDate().getTime();
    ...
    public int selectionForKey(char aKey, ComboBoxModel aModel) {
        long now = new connect.SystemOptions().ServerDate().getTime();
    ...
    /*public static void main(String arg[]) {
        ...
        JComboBox cBox= new AutoCompleteCombo(names);
        //Locale[] locales = Locale.getAvailableLocales();//
        //JComboBox cBox = new AutoCompleteCombo(locales);
