 ...
 */
public class FrmAppropApproval extends javax.swing.JInternalFrame {
    private String appPath = System.getProperties().getProperty("user.dir");
    private final boolean NUMERIC = true; 
    /**
     * Creates new form FrmAppropApproval
     */
    public FrmAppropApproval() {
        initComponents();
        loadAppropriation();
    }
    ...
    private void loadAppropriation(){
        ...
        try {
                ...
                java.util.logging.Logger.getLogger("FrmAppropApproval").log(java.util.logging.Level.SEVERE, null, e);
        } finally {
                if (dbc != null) try {
                    dbc.close();
                    ...
                    java.util.logging.Logger.getLogger("FrmAppropApproval").log(java.util.logging.Level.SEVERE, null, ex);
                }
        }
    ...
    private void initComponents() {
        ...
        chDateAppropApproval = new datechooser.beans.DateChooserCombo();
        jLabel7 = new javax.swing.JLabel();
        tabPanePreview = new javax.swing.JTabbedPane();

        setClosable(true);
        setMaximizable(true);
        setTitle("APPROPRIATION-Approval");
            ...
            .addGroup(panelListLayout.createSequentialGroup()
                ...
                .addGroup(panelListLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(panelListLayout.createSequentialGroup()
                        ...
                        .addGap(6, 6, 6)
                        .addComponent(chDateAppropApproval, javax.swing.GroupLayout.PREFERRED_SIZE, 119, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(panelListLayout.createSequentialGroup()
                ...
                .addGroup(panelListLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(panelListLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addComponent(chDateAppropApproval, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 24, javax.swing.GroupLayout.PREFERRED_SIZE)
...
//            printButton.setVisible(false);
    ...
    private void btnApproveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnApproveActionPerformed
        ...
        if(resp==javax.swing.JOptionPane.YES_OPTION){
            ...
            try {
                ...
                dbase.SQLExecute updateFundControl = new dbase.SQLExecute("buds.appropriation_status");
                updateFundControl.FieldName("fund_id",  NUMERIC, enums.Take.ConditionOnly, Integer.valueOf(tblRecords.getValueAt(tblRecords.getSelectedRow(), 6).toString()));
                updateFundControl.FieldName("legal_base",  NUMERIC, enums.Take.ConditionOnly, Integer.valueOf(tblRecords.getValueAt(tblRecords.getSelectedRow(), 5).toString()));
                ...
                if (dbc != null) try {
                    ...
                    java.util.logging.Logger.getLogger("FrmAppropApproval").log(java.util.logging.Level.SEVERE, null, rlbk);
                }
    ...
    private datechooser.beans.DateChooserCombo chDateAppropApproval;
