 ...
 */
public class FrmAllotCancellation extends javax.swing.JInternalFrame {
private final boolean NUMERIC = true;  
private String appPath = System.getProperties().getProperty("user.dir");
    /**
     * Creates new form FrmAllotCancellation
     */
    public FrmAllotCancellation() {
        initComponents();
        loadAllotment();
    }
    ...
    private void loadAllotment(){
        ...
        try {
                ...
                java.util.logging.Logger.getLogger("DlgAppropriationAllotment").log(java.util.logging.Level.SEVERE, null, e);
        } finally {
                if (dbc != null) try {
                    dbc.close();
                    ...
                    java.util.logging.Logger.getLogger("DlgAppropriationAllotment").log(java.util.logging.Level.SEVERE, null, ex);
                }
        }
    ...
    private void initComponents() {
        ...
        btnCancel.setText("Cancel Allotment");
        ...
        tblRecords.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CONTROL#", "DATE", "LEGAL BASIS", "FUND ACCOUNT", "STATUS", "LEGAL", "CTRLUID"
            }
        ) {
    ...
    private void btnPreviewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPreviewActionPerformed
        ...
        try {
            ...
            java.util.logging.Logger.getLogger("FrmAllotCancellation").log(java.util.logging.Level.SEVERE, null, ex);
        }
        setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
    ...
    private void btnCancelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelActionPerformed
        ...
        try {
            ...
            dbase.SQLExecute deleteApplication = new dbase.SQLExecute("buds.allotment_status");
            deleteApplication.FieldName("control_id",  !NUMERIC, enums.Take.InsertUpdate, true,tblRecords.getValueAt(tblRecords.getSelectedRow(), 0).toString());           
            ...
            if (dbc != null) try {
                ...
                java.util.logging.Logger.getLogger("FrmAllotCancellation").log(java.util.logging.Level.SEVERE, null, rlbk);
            }
